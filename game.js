...
let rules = document.getElementById('tutorial-overlay')
...
// Hiding the rules overlay //
rules.style.visibility = "hidden";
// Creating an Array of sentences to hold the Tutorial messages //
let tut = ["Each Player starts with 5 Health (HP)","And 1 base Attack Power (PWR)", "Press'W' or 'Up-Arrow' to Attack your opponent", "Press 'A or 'Left-Arrow' to Defend", "Press 'D' or 'Right-Arrow to Charge"];let i = 0;
...
function tutorial() {
    ...
    if(i == 0){
        ...
        setTimeout(function(){ 
            ...
            document.getElementById("p1PWR").style.color = "#D10000";
        ...
        setTimeout(function(){
            p1PWR.innerText = `PWR: ${player1.ATK + 1}`;
            document.getElementById("p2PWR").innerHTML =` PWR: ${player2.ATK + 1}`;
            document.getElementById("p1PWR").style.color = "#cca633";
            document.getElementById("p2PWR").style.color = "#cca633"; 
            inputField.innerText = tut[i-1];
            i++
        }, 14500); 
        ...
        setTimeout(function(){
            // inputField.innerText = tut[i-1]; 
            inputField.innerText = "Click 'Game Rules' for more information"
        }, 18000);
        setTimeout(function(){
         help.innerHTML = "Game Rules"
